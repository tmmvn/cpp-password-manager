...
void TestGroupModel::test()
{
	...
	QModelIndex indexRoot = model->index(
		0,
		0
	);
	...
	QModelIndex index11 = model->index(
		0,
		0,
		index1
	);
	QPersistentModelIndex index12 = model->index(
		1,
		0,
		index1
	);
	QModelIndex index121 = model->index(
		0,
		0,
		index12
	);
	QCOMPARE(
		model->data(indexRoot).toString(),
		QString("groupRoot")
	);
	QCOMPARE(
	...
	QCOMPARE(
		model->data(index11).toString(),
		QString("group11")
	);
	QCOMPARE(
		model->data(index12).toString(),
		QString("group12")
	);
	QCOMPARE(
		model->data(index121).toString(),
		QString("group121")
	);
	QSignalSpy spy1(
		model,
	...
	// QCOMPARE(
	// 	model->data(index12::index(0, 0)).toString(),
	// 	QString("group121")
	// );
	delete group12;
	QCOMPARE(
